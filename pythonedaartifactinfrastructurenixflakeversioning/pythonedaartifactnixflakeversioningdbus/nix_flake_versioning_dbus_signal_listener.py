"""
pythonedaartifactinfrastructurenixflakeversioning/pythonedaartifactnixflakeversioningdbus/nix_flake_versioning_dbus_signal_listener.py

This file defines the NixFlakeVersioningDbusSignalListener class.

Copyright (C) 2023-today rydnr's pythoneda-artifact-infrastructure/nix-flake-versioning
...
class NixFlakeVersioningDbusSignalListener(DbusSignalListener):

    """
    A Port that listens to Versioning-relevant d-bus signals.

    Class name: NixFlakeVersioningDbusSignalListener

    Responsibilities:
        - Connect to d-bus.
        - Listen to signals relevant to Nix Flake Versioning domain.
    ...
    def __init__(self):
        """
        Creates a new NixFlakeVersioningDbusSignalListener instance.
        """
        super().__init__()
    ...
    async def listen_pythonedaartifactversioning_VersionCreated(self, event: VersionCreated):
        ...
        :type event: pythonedaartifactversioning.version_created.VersionCreated
        """
